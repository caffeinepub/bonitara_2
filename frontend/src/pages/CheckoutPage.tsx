  ...
  if (ordered) return (
    <div className="container mx-auto px-4 py-24 text-center max-w-md">
      ...
      <p className="font-sans text-xs text-muted-foreground mb-8">
        Order ID: BON-{Date.now().toString().slice(-8)}
      </p>
      <a
        href="#/"
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={f.name} className={f.full ? 'sm:col-span-2' : ''}>
                      <label className="block font-sans text-xs text-charcoal mb-1.5 tracking-wide">
                        {f.label} *
                      </label>
                      <input
                        type={f.type}
                  ...
                  {[
                    ...
                    <label
                      ...
                      className={`flex items-center gap-4 p-4 border rounded-sm cursor-pointer transition-colors ${
                        payment === opt.id ? 'border-gold bg-beige' : 'border-border hover:border-gold/50'
            ...
            <div className="bg-card border border-border p-6 rounded-sm h-fit">
              ...
              <div className="space-y-2 text-sm font-sans border-t border-border pt-4 mb-6">
